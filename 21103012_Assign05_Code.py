...
lbl_1=Label(win,text='ENTER ORIGINAL PRICE',bg='white',relief='ridge',padx=3,pady=3,bd=3,font=('calibre',14,'bold','underline'))
lbl_1.grid(row=1,column=1,padx=10,pady=10)
lbl_2=Label(win,text="ENTER NET PRICE",bg='yellow',relief='ridge',padx=3,pady=3,bd=3,font=('calibre',14,'bold','underline'))
...
lbl_3=Label(win,text="GST RATE IS",bg='pink',relief='ridge',padx=3,pady=3,bd=3,font=('calibre',14,'bold','underline'))
lbl_3.grid(row=4,column=1,padx=10,pady=10)
but_2=Button(win,text="Clear",padx=3,pady=3,bg='white',relief='sunken',bd=3,font=('calibre',14),command=clear_all,activebackground='red')
...
if __name__ == "__main__":
	...
	expression_field = Entry(gui, textvariable=equation,bg='white')
